          ...
          return (
            <button
              ...
              style={{
                ...
                cursor: 'pointer',
                position: 'relative',
                backgroundColor: isActive ? 'rgba(254, 165, 95, 0.05)' : 'transparent',
                color: isActive ? '#FFFFFF' : '#607B96',
                boxShadow: isActive ? '0 0 20px rgba(254, 165, 95, 0.05)' : 'none'
              }}
              onMouseEnter={(e) => {
                if (!isActive) {
            ...
            >
              ...
              <Icon
                ...
                style={{
                  ...
                  filter: isActive ? 'drop-shadow(0 0 8px rgba(254, 165, 95, 0.5))' : 'none'
                }}
              />
...
export default function AdminLayout({
  ...
  const sidebarLinks: SidebarLink[] = [
    ...
    { id: "projects", label: "Projects", icon: PlusCircle, href: "/admin/projects" },
    { id: "education", label: "Education", icon: GraduationCap, href: "/admin/education" },
    { id: "certifications", label: "Certifications", icon: Award, href: "/admin/certifications" },
    { id: "skills", label: "Skills", icon: Terminal, href: "/admin/skills" },
    { id: "tech-icons", label: "TechIcons", icon: Cpu, href: "/admin/tech-icons" },
