      ...
      >
        <div style={{
          ...
          <div style={{
            ...
            width: '100%',
            height: '4px',
            background: 'linear-gradient(to right, transparent, rgba(254, 165, 95, 0.4), transparent)'
          }} />
          ...
          <div style={{
            ...
            <motion.div 
              ...
              style={{
                ...
                height: '96px',
                borderRadius: '24px',
                background: 'linear-gradient(to bottom right, #1C2B3A, #010C15)',
                color: '#FEA55F',
                marginBottom: '40px',
                position: 'relative',
                border: '1px solid rgba(255, 255, 255, 0.08)',
                boxShadow: 'inset 0 0 0 1px rgba(255, 255, 255, 0.05), 0 0 20px rgba(254, 165, 95, 0.1)'
              }}
            >
              <ShieldCheck size={44} style={{ position: 'relative', zIndex: 10 }} />
            </motion.div>
          ...
          <form onSubmit={handleSendOTP} style={{
            ...
            onMouseEnter={(e) => {
              const blur = e.currentTarget.querySelector('div:first-child');
            ...
            >
              <div style={{
                position: 'absolute',
                inset: '-4px',
                background: 'linear-gradient(to right, rgba(254, 165, 95, 0.2), transparent)',
                borderRadius: '16px',
                filter: 'blur(8px)',
                opacity: 0,
            ...
            >
              ...
              onMouseEnter={(e) => {
                if (!loading) e.style.transform = 'translateX(100%)';
              }}
              onMouseLeave={(e) => {
              ...
              <div style={{
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    <ArrowRight size={22} style={{ transition: 'transform 0.3s ease' }} />
                  </>
                )}
              </div>
            </button>
