        ...
        >
          ...
          <div
            style={{
              ...
              height: "4px",
              background:
                "linear-gradient(to right, transparent, rgba(67, 217, 173, 0.4), transparent)",
            }}
          />
          ...
          >
            <motion.div
              ...
              style={{
                ...
                border: "1px solid rgba(255, 255, 255, 0.08)",
                boxShadow:
                  "inset 0 0 0 1px rgba(255, 255, 255, 0.05), 0 0 20px rgba(67, 217, 173, 0.15)",
              }}
            >
              <ShieldAlert size={44} />
            </motion.div>
            ...
            >
              A temporary access key has been dispatched to your terminal at{" "}
              <br />
              <span
                style={{
                  color: "#43D9AD",
          ...
          >
            ...
            >
              ...
              >
                <Mail size={12} style={{ opacity: 0.7 }} /> Encryption:
                TLS_AES_GCM_256
              </div>
            </div>
          </footer>
