          ...
          >
            ...
            >
              ...
              >
                      ...
                      >
                        ...
                        <span
                          style={{
                            ...
                            fontWeight: "500",
                            color:
                              selectedColor === c.value ? "#FFFFFF" : "#607B96",
                          }}
                        >
                          {c.name}
                        </span>
                        {selectedColor === c.value && (
                          <Check
                            size={14}
                            style={{ color: "#43D9AD", marginLeft: "4px" }}
                          />
                        )}
                      </button>
                    ))}
                ...
                >
                  <AlertCircle
                    style={{ color: "#FEA55F", flexShrink: 0 }}
                    size={20}
                  />
                  <div
                    style={{
                  ...
                  >
                    ...
                    >
                      Uploaded assets will be automatically traced into
                      production-ready SVGs using the selected theme color.
                      Lossless scaling guaranteed.
                    </p>
                  </div>
                </div>
