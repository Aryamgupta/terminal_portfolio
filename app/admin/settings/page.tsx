...
const SettingsPage = () => {
  ...
  const handleTriggerRebuild = async () => {
    ...
    try {
      ...
      if (!res.ok) throw new Error(data.error || "Uplink failed to trigger rebuild sequence.");
      
      setMessage({ type: "success", text: "Production rebuild sequence initiated. Monitor deployment terminal for progress." });
    } catch (err: any) {
        ...
        >
          ...
          <div style={{
            ...
            <div style={{
              ...
              <RefreshCw 
                ...
                color="#FEA55F"
                style={{
                  animation: loadingRebuild ? 'spin 1s linear infinite' : 'none'
                }}
              />
            </div>
          </div>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '16px',
              border: 'none',
              cursor: loadingRebuild ? 'not-allowed' : 'pointer',
          ...
          >
            {loadingRebuild ? <Loader2 style={{ animation: 'spin 1s linear infinite' }} size={22} /> : <RefreshCw size={22} />}
            <span style={{
